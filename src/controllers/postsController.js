...
import { listPosts, getPost, createUserPost, updateUserPost, deleteUserPost, getRemainingPosts, getWeeklySpotlight } from "../services/postsService.js";
import { uploadImageBuffer } from "../services/cloudinaryService.js";

export const spotlight = asyncHandler(async (req, res) => {
  res.json(await getWeeklySpotlight(req.userId));
});
